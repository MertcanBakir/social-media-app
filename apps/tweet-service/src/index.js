...
async function startServer() {
  try {
    ...
    app.listen(PORT, async () => {
      ...
      const name = process.env.REGISTRY_NAME || "tweet-service";
      const address = process.env.REGISTRY_ADDRESS || "http://tweet-service";
      ...
      console.log("🔁 registry heartbeat başladı (tweet-service)");
    });
  } catch (err) {
